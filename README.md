...
Выбор технологий на Ваше усмотрение. Наш совет — DRF + Postgres. ⁉️так нужны или нет таблицы? ) 
...
❗️Для преобразования приложения в API достаточно будет изменить RESPONSE_CLASS и виды ответов сервера. 

❗️В реалном проекте присутствует модуль логирования!
